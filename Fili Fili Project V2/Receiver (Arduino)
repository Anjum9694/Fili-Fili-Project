...
// This code allows wireless infrared receiving with Arduino UNO
// https://github.com/Anjum9694

#include <IRremote.h>

// An IR detector/demodulator is connected to pin 9 on an Arduino UNO
// board).
const uint16_t kRecvPin = 9;
...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("Fili Fili Project IR receiver has started successfully.");
}
